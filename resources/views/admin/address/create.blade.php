...
<div class="p-4 code-to-copy">
    ...
    <form enctype="multipart/form-data" method="post" action="{{route('admin.address.store',  TranslateUtility::getLang())}}">
        @csrf
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade @if($loop->first) show active @endif" id="content-{{ $lang->code }}" role="tabpanel" aria-labelledby="tab-{{ $lang->code }}">
                        <div class="mb-6 input_group_second">
                            <input name="title[{{ $lang->code }}]" class="form-control @error('title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'address_name', TranslateUtility::getLang())}}" value="{{ old('title.' . $lang->code) }}" />
