...
<div class="p-4 code-to-copy">
    <form method="post" action="{{route('admin.email.store', $lang)}}">
        @csrf
        ...
        <div style="column-gap: 10px" class="d-flex">
            <div style="flex:6">
                <div class="mb-6 input_group_first">
                    <input name="data" class="form-control @error('data') is-invalid @enderror" id="exampleFormControlInput" type="text" placeholder="email" value="{{ old('data') }}" />
                    @error('data')
