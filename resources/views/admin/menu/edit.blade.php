...
@section('content')
    ...
    <div class="p-4 code-to-copy">
        ...
        <form enctype="multipart/form-data" method="post" action="{{ route('admin.menu.update', ['lang' => TranslateUtility::getLang(), 'menu' => $menu->id]) }}">
            @method('PATCH')
            @csrf
            <div style="column-gap: 10px; align-items: center;">
                        ...
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="title-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="slug[{{ $lang->code }}]" class="form-control @error('slug.' . $lang->code) is-invalid @enderror" type="text" placeholder="Slug  - {{ $lang->code }}" value="{{ old('slug.' . $lang->code, $menu->getWithLocale($lang->code)->slug ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="seo-title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="seo-title-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="seo_title[{{ $lang->code }}]" class="form-control @error('seo_title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'seo_title', $lang->code)}}" value="{{ old('seo_title.' . $lang->code, $menu->getWithLocale($lang->code)->seo_title ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="meta-keywords-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="meta-keywords-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="meta_keywords[{{ $lang->code }}]" class="form-control @error('meta_keywords.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'meta_keywords', $lang->code)}}" value="{{ old('meta_keywords.' . $lang->code, $menu->getWithLocale($lang->code)->meta_keywords ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="meta-description-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="meta-description-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <textarea name="meta_description[{{ $lang->code }}]" class="form-control @error('meta_description.' . $lang->code) is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('meta_description', 'menu_select_code', $lang->code)}}">{{ old('meta_description.' . $lang->code, $menu->getWithLocale($lang->code)->meta_description ?? '') }}</textarea>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <textarea name="seo_links" class="form-control summernote @error('seo_link') is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'se_Links', TranslateUtility::getLang())}}">{{ old('seo_links', $menu->seo_links) }}</textarea>
                        @error('seo_link')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <textarea name="seo_scripts" class="form-control summernote @error('seo_script') is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'seo_scripts', TranslateUtility::getLang())}}">{{ old('seo_scripts', $menu->seo_scripts) }}</textarea>
                        @error('seo_script')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <input name="code" class="form-control @error('code') is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'menu_select_code',TranslateUtility::getLang())}}" value="{{ old('code', $menu->code) }}" />
                        @error('code')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
