...
@section('content')
    ...
    <div class="p-4 code-to-copy">
        ...
        <form enctype="multipart/form-data" method="post" action="{{route('admin.brands.store', TranslateUtility::getLang())}}">
            @csrf
            <div style="column-gap: 10px; align-items: center;">
                        ...
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="title-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="title[{{ $lang->code }}]" class="form-control @error('title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'brand_title', $lang->code)}}" value="{{ old('title.' . $lang->code) }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="seo-title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="seo-title-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="seo_title[{{ $lang->code }}]" class="form-control @error('seo_title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'brand_seo_title', $lang->code)}}" value="{{ old('seo_title.' . $lang->code) }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="meta-keywords-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="meta-keywords-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="meta_keywords[{{ $lang->code }}]" class="form-control @error('meta_keywords.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'brand_meta_keywords', $lang->code)}}" value="{{ old('meta_keywords.' . $lang->code) }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="meta-description-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="meta-description-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <textarea name="meta_description[{{ $lang->code }}]" class="form-control @error('meta_description.' . $lang->code) is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'brand_meta_description', $lang->code)}}">{{ old('meta_description.' . $lang->code) }}</textarea>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <textarea name="seo_links" class="form-control summernote @error('seo_link') is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'brand_seo_links', TranslateUtility::getLang())}}">{{ old('seo_link') }}</textarea>
                        @error('seo_link')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <textarea name="seo_scripts" class="form-control summernote @error('seo_script') is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'brand_seo_links',TranslateUtility::getLang())}}">{{ old('seo_script') }}</textarea>
                        @error('seo_script')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
