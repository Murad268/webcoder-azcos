...
@section('content')
    <div class="p-4 code-to-copy">
        <form enctype="multipart/form-data" method="post" action="{{ route('admin.categories.update', ['lang' =>TranslateUtility::getLang(), 'category' => $category->id]) }}">
            @method('PATCH')
            @csrf
            <div style="column-gap: 10px; align-items: center;">
                    ...
                    <div class="tab-content">
                        <div class="" role="tabpanel" aria-labelledby="tab-">
                            <div class="mb-6 mt-6 input_group_second">
                                <select placeholder="{{TranslateUtility::getTranslate('admin_form', 'select_product_colors', TranslateUtility::getLang())}}" name="color_schemes[]" class="form-select2" multiple="multiple" aria-label="Default select example">
                ...
                <!-- Product Types -->
                <div style="flex:6;">
                    <select id="productTypes" placeholder="{{TranslateUtility::getTranslate('admin_form', 'select_product_types', $langMain)}}" name="product_types[]" class="form-control @error('product_types') is-invalid @enderror" multiple>
                        @foreach($productTypes as $productType)
                            <option value="{{ $productType->id }}" {{ in_array($productType->id, $selectedTypes) ? 'selected' : '' }}>{{ $productType->getWithLocale(TranslateUtility::getLang())->title ?? ''}}</option>
                        @endforeach
                    </select>
                    @error('product_types')
                    <div class="invalid-feedback">
                        ...
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="translatable-title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="translatable-title-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="title[{{ $lang->code }}]" class="form-control @error('title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_title', $lang->code)}}" value="{{ old('title.' . $lang->code, $category->getWithLocale($lang->code)->title ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="title-first-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="title-first-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="title_first[{{ $lang->code }}]" class="form-control @error('title_first.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_first_title', $lang->code)}}" value="{{ old('title_first.' . $lang->code, $category->getWithLocale($lang->code)->title_first ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="title-second-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="title-second-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="title_second[{{ $lang->code }}]" class="form-control @error('title_second.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_title_second', $lang->code)}}" value="{{ old('title_second.' . $lang->code, $category->getWithLocale($lang->code)->title_second ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="subtitle-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="subtitle-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="subtitle[{{ $lang->code }}]" class="form-control @error('subtitle.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_subtitle', $lang->code)}}" value="{{ old('subtitle.' . $lang->code, $category->getWithLocale($lang->code)->subtitle ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="text-first-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="text-first-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <textarea name="text_first[{{ $lang->code }}]" id="summernote-text-first-{{ $lang->code }}" class="form-control @error('text_first.' . $lang->code) is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_text_first', $lang->code)}}">{{ old('text_first.' . $lang->code, $category->getWithLocale($lang->code)->text_first ?? '') }}</textarea>
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="text-second-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="text-second-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <textarea name="text_second[{{ $lang->code }}]" id="summernote-text-second-{{ $lang->code }}" class="form-control @error('text_second.' . $lang->code) is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_text_second', $lang->code)}}">{{ old('text_second.' . $lang->code, $category->getWithLocale($lang->code)->text_second ?? '') }}</textarea>
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="text-center-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="text-center-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <textarea name="text_center[{{ $lang->code }}]" id="summernote-text-center-{{ $lang->code }}" class="form-control @error('text_center.' . $lang->code) is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'text_center', $lang->code)}}">{{ old('text_center.' . $lang->code, $category->getWithLocale($lang->code)->text_center ?? '') }}</textarea>
                    ...
                    <div class="col-md-12">
                        <div class="tab-content">
                            <div class=" " id="text-first-content-" role="tabpanel" aria-labelledby="text-first-tab-">
                                <div class="mb-6 input_group_second">
                                    <input name="video_link" class="form-control @error('video_link') is-invalid @enderror" type="text" placeholder="{{ TranslateUtility::getTranslate('admin_form', 'category_video_link', TranslateUtility::getLang()) }}" value="{{ old('video_link', $category->video_link ?? '') }}" />
                                    @error('video_link')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="seo-title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="seo-title-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="seo_title[{{ $lang->code }}]" class="form-control @error('seo_title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_seo_title', $lang->code)}}" value="{{ old('seo_title.' . $lang->code, $category->getWithLocale($lang->code)->seo_title ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="meta-keywords-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="meta-keywords-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <input name="meta_keywords[{{ $lang->code }}]" class="form-control @error('meta_keywords.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_meta_keywords', $lang->code)}}" value="{{ old('meta_keywords.' . $lang->code, $category->getWithLocale($lang->code)->meta_keywords ?? '') }}" />
                    ...
                    <div class="tab-content">
                        @foreach($langs as $lang)
                            <div class="tab-pane fade @if($loop->first) show active @endif" id="meta-description-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="meta-description-tab-{{ $lang->code }}">
                                <div class="mb-6 input_group_second">
                                    <textarea name="meta_description[{{ $lang->code }}]" class="form-control @error('meta_description.' . $lang->code) is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_meta_description', $lang->code)}}">{{ old('meta_description.' . $lang->code, $category->getWithLocale($lang->code)->meta_description ?? '') }}</textarea>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <textarea name="seo_links" id="summernote-seo-links" class="form-control @error('seo_links') is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_seo_links', TranslateUtility::getLang())}}">{{ old('seo_links', $category->seo_links ?? '') }}</textarea>
                        @error('seo_links')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div style="flex:6;">
                    <div class="mb-6 input_group_second">
                        <textarea name="seo_scripts" id="summernote-seo-scripts" class="form-control @error('seo_scripts') is-invalid @enderror" placeholder="{{TranslateUtility::getTranslate('admin_form', 'category_scripts', TranslateUtility::getLang())}}">{{ old('seo_scripts', $category->seo_scripts ?? '') }}</textarea>
                        @error('seo_scripts')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        const codeStyles = document.querySelectorAll("textarea");

        codeStyles.forEach(styles => {
            console.log(styles)
        })
    </script>
@endsection
