...
@section('content')
    ...
    <div class="p-4 code-to-copy">
        ...
        <form enctype="multipart/form-data" method="post" action="{{route('admin.products.update', ['product' => $product->id, 'lang' => TranslateUtility::getLang(), 'page' => request()->get('page', 1)])}}">
            @csrf
            @method('PATCH')
            <div style="column-gap: 10px; align-items: center;">
                    ...
                    <div class="tab-content">
                        <div class=" " role="tabpanel" aria-labelledby="tab-">
                            <div class="mb-6 mt-6 input_group_second">
                                <select name="tags[]" placeholder="{{TranslateUtility::getTranslate('admin_form', 'select_product_tags', TranslateUtility::getLang())}}" id="mySelect22" multiple="multiple" style="width: 100%;">
                                    @foreach($tags as $tag)
                                        <option value="{{ $tag->id }}" {{ in_array($tag->id, $selectedTags) ? 'selected' : '' }}>
                                            {{ $tag->getWithLocale(TranslateUtility::getLang()) ? $tag->getWithLocale(TranslateUtility::getLang())->tag : '' }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div style="flex:6;">
                            <div class="tab-content">
                                <div class=" " role="tabpanel" aria-labelledby="tab-">
                                    <div class="mb-6 mt-6 input_group_second">
                                        <select name="color_schemes[]" placeholder="{{TranslateUtility::getTranslate('admin_form', 'select_product_colors', $lang)}}" id="mySelect2" multiple="multiple" style="width: 100%;">
                                            @foreach($colors as $color)
                                                <option value="{{ $color->id }}" {{ in_array($color->id, $selectedColors) ? 'selected' : '' }}>
                                                    {{ $color->getWithLocale(TranslateUtility::getLang()) ? $color->getWithLocale(TranslateUtility::getLang())->title : '' }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class=" " role="tabpanel" aria-labelledby="tab-">
                            <div class="mb-6 mt-6 input_group_second">
                                <select name="brand_id" class="form-select" aria-label="Default select example">
                                    <option value="0">{{TranslateUtility::getTranslate('admin_form', 'select_product_brand',TranslateUtility::getLang())}}</option>
                                    @foreach($brands as $brand)
                                        <option {{$brand->id == $product->brand_id ? 'selected' : ""}} value="{{$brand->id}}">{{$brand->getWithLocale(TranslateUtility::getLang()) ? $brand->getWithLocale(TranslateUtility::getLang())->title : "" }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="tab-content">
                        <div class="" id="title-content-" role="tabpanel" aria-labelledby="title-tab-">
                            <div class="mb-6 input_group_second">
                                <input value="{{$product->product_code}}" name="product_code" class="form-control @error('product_code') is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_code', $lang)}}" value="{{ old('product_code', $product->product_code) }}" />
                                @error('product_code')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div style="flex:6;">
                    ...
                    <div class="tab-content">
                        <div class="  " id="title-content-" role="tabpanel" aria-labelledby="title-tab-">
                            <div class="mb-6 input_group_second">
                                <input name="video_link" class="form-control @error('video_link') is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_video_link',TranslateUtility::getLang())}}" value="{{ old('video_link', $product->video_link) }}" />
                                @error('video_link')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div style="flex:6;">
                    ...
                    <div class="tab-content">
                        <div class="  " id="title-content-" role="tabpanel" aria-labelledby="title-tab-">
                            <div class="mb-6 input_group_second">
                                <input name="price" class="form-control @error('price') is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_price', TranslateUtility::getLang())}}" value="{{ old('price', $product->price) }}" />
                                @error('price')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="title-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <input name="title[{{ $lang->code }}]" class="form-control @error('title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_title', $lang->code)}}" value="{{ old('title.' . $lang->code, $product->getWithLocale($lang->code)->title ?? '') }}" />
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="subtitle-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="subtitle-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <input name="subtitle[{{ $lang->code }}]" class="form-control @error('subtitle.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_subtitle', $lang->code)}}" value="{{ old('subtitle.' . $lang->code, $product->getWithLocale($lang->code)->subtitle ?? '') }}" />
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="how-to-use-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="how-to-use-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_how_to_use', $lang->code)}}" id="summernote-how-to-use-{{ $lang->code }}" name="how_to_use[{{ $lang->code }}]" class="form-control @error('how_to_use.' . $lang->code) is-invalid @enderror">{{ old('how_to_use.' . $lang->code, $product->getWithLocale($lang->code)->how_to_use ?? '') }}</textarea>
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="product-details-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="product-details-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_details', $lang->code)}}" id="summernote-product-details-{{ $lang->code }}" name="product_detail_text[{{ $lang->code }}]" class="form-control @error('product_detail_text.' . $lang->code) is-invalid @enderror">{{ old('product_detail_text.' . $lang->code, $product->getWithLocale($lang->code)->product_detail_text ?? '') }}</textarea>
                                            @error('product_detail_text.' . $lang->code)
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                            @enderror
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="ingredients-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="ingredients-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_ingredients', TranslateUtility::getLang())}}" id="summernote-ingredients-{{ $lang->code }}" name="ingredients[{{ $lang->code }}]" class="form-control @error('ingredients.' . $lang->code) is-invalid @enderror">{{ old('ingredients.' . $lang->code, $product->getWithLocale($lang->code)->ingredients ?? '') }}</textarea>
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="seo-title-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="seo-title-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <input name="seo_title[{{ $lang->code }}]" class="form-control @error('seo_title.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_seo_title', $lang->code)}}" value="{{ old('seo_title.' . $lang->code, $product->getWithLocale($lang->code)->seo_title ?? '') }}" />
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="seo-keywords-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="seo-keywords-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <input name="meta_keywords[{{ $lang->code }}]" class="form-control @error('meta_keywords.' . $lang->code) is-invalid @enderror" type="text" placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_meta_keywords', $lang->code)}}" value="{{ old('meta_keywords.' . $lang->code, $product->getWithLocale($lang->code)->meta_keywords ?? '') }}" />
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="seo-description-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="seo-description-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_meta_description', $lang->code)}}" name="meta_description[{{ $lang->code }}]" class="form-control @error('meta_description.' . $lang->code) is-invalid @enderror">{{ old('meta_description.' . $lang->code, $product->getWithLocale($lang->code)->meta_description ?? '') }}</textarea>
                ...
                <div class="form-row" style="display: flex;">
                    ...
                    <div class="col-md-6">
                        <div style="flex:6;">
                            <div class="mb-6 input_group_second">
                                <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_seo_link',TranslateUtility::getLang())}}" name="seo_links" id="summernote-seo-link" class="form-control @error('seo_link') is-invalid @enderror">{{ old('seo_link', $product->seo_link) }}</textarea>
                                @error('seo_link')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="col-md-6">
                        <div style="flex:6;">
                            <div class="mb-6 input_group_second">
                                <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_seo_scripts', TranslateUtility::getLang())}}" name="seo_scripts" id="summernote-seo-script" class="form-control @error('seo_script') is-invalid @enderror">{{ old('seo_script', $product->seo_script) }}</textarea>
                                @error('seo_script')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="tab-content">
                                @foreach($langs as $lang)
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="text-content-{{ $lang->code }}" role="tabpanel" aria-labelledby="text-tab-{{ $lang->code }}">
                                        <div class="mb-6 input_group_second">
                                            <textarea placeholder="{{TranslateUtility::getTranslate('admin_form', 'product_text', $lang->code)}}" id="summernote-text-{{ $lang->code }}" name="text[{{ $lang->code }}]" class="form-control @error('text.' . $lang->code) is-invalid @enderror">{{ old('text.' . $lang->code, $product->getWithLocale($lang->code)->text ?? '') }}</textarea>
            ...
            tab.addEventListener('click', function(e) {
                ...
                document.querySelectorAll(paneSelector).forEach(pane => {
                    if (pane.id === targetTab) {
                        ...
                        initializeSummernote(`#${targetTab} textarea`);
                    } else {
