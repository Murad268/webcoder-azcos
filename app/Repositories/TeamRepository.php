...
use App\Models\Team;
use App\Models\TeamImages;
use App\Models\TeamTranslates;

class TeamRepository
{
    protected $modelClassCategories = Team::class;
    protected $modelClassCategoriesTranslates = TeamTranslates::class;
    protected $modelClassCategoryImage = TeamImages::class;
